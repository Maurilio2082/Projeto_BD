-- Removendo as chaves estrangeiras das tabelas - Execultar somente quando quiser excluir as tabelas
/*
ALTER TABLE ESPECIALIDADE_MEDICO DROP FOREIGN KEY especialidade_especialidade_medico_fk;
ALTER TABLE ESPECIALIDADE_MEDICO DROP FOREIGN KEY medico_especialidade_medico_fk;
ALTER TABLE HOSPITAL_MEDICO DROP FOREIGN KEY medico_hospital_medico_fk;
ALTER TABLE HOSPITAL_MEDICO DROP FOREIGN KEY hospital_hospital_medico_fk;
...
ALTER TABLE HISTORICO DROP FOREIGN KEY especialidade_historico_fk; 
ALTER TABLE HISTORICO DROP FOREIGN KEY medico_historico_fk;
 */
...
ADD CONSTRAINT especialidade_historico_fk FOREIGN KEY (ID_ESPECIALIDADE) REFERENCES ESPECIALIDADE (ID_ESPECIALIDADE) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE HISTORICO
ADD CONSTRAINT medico_historico_fk FOREIGN KEY (ID_MEDICO) REFERENCES MEDICO (ID_MEDICO) ON DELETE NO ACTION ON UPDATE NO ACTION;
